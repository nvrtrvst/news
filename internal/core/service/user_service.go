...
import (
	"context"
	"news-web/config"
	"news-web/internal/adapter/repository"
...
type authService struct {
	...
	cfg            *config.Config
	jwtToken       auth.JwtService
	// Add dependencies like repositories here
}
...
func NewAuthService(authRepository repository.AuthRepository, cfg *config.Config, jwtToken auth.JwtService) AuthService {
	return &authService{
